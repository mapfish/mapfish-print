...
public class TMSLayerTest extends PrintTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        tmsSpec = MapPrinter.parseSpec(FileUtilities.readWholeTextFile(
                new File(TMSLayerTest.class.getClassLoader().getResource("layers/layer_spec.json").getFile())
        ));
	...
	public void testNoOrigin() throws JSONException{
        ...
        //assertEquals("Default format (null path_format) did not get created correctly", , );

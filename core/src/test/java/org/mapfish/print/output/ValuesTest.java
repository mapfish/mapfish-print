...
public class ValuesTest extends AbstractMapfishSpringTest {
    ...
    public void testNoDefaults() throws Exception {
        ...
        final Configuration config = configurationFactory.getConfig(
            getFile(BASE_DIR + "config-no-defaults.yaml")
        );
        ...
        final Map<String, Object>[] attributesValues = values.getObject(
            "datasource",
        ...
        final TableAttribute.TableAttributeValue table = (TableAttribute.TableAttributeValue) attributesValues[0].get(
                "table"
            );

...
public class MapfishParserTest {
  public static void populateLayerParam(
      PObject requestData, Object param, String... extraNamesToIgnore) throws JSONException {
  ...
  public void testPopulateLayerParam() throws IOException {
    ...
    final PJsonObject json =
        parseJSONObjectFromFile(MapfishParserTest.class, "mapAttributeTest.json");
    ...
    assertTrue(param.oa[1].has("b"));
    assertTrue(param.calledByPostConstruct);
  ...
  static class TestParam {
    public String s;
    @HasDefaultValue public String defS = "default";
    @HasDefaultValue public String defS2 = "default2";
    public Integer bigI;
    public int littleI;
    public Double bigD;
  ...
  static class EmbeddedClass {
    ...
    @HasDefaultValue public String embeddedDefault = "def";
    private boolean calledByPostConstruct = false;
  ...
  static class OptionalArrayParam {
    @HasDefaultValue public String[] sa;
  }

  static class TestEnumParam {
    public TestEnum e1 = TestEnum.DEF;
    public TestEnum[] e2;
    @HasDefaultValue public TestEnum def2 = TestEnum.DEF;
  }
  ...
  static class TestRequireClass {
    ...
    @HasDefaultValue public Boolean b;
    @HasDefaultValue public Boolean c;
  }

...
/**
 * Test for the CreateOverviewMap processor, where the overview map has its own layers and where a
 * style is set on these layers.
 */
public class CreateOverviewMapProcessorCustomLayerTest extends AbstractMapfishSpringTest {
  ...
  private static PJsonObject loadJsonRequestData() throws IOException {
    return parseJSONObjectFromFile(
        CreateOverviewMapProcessorCustomLayerTest.class, BASE_DIR + "requestData.json");
  }

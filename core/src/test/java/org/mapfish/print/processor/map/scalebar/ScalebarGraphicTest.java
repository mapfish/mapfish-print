...
public class ScalebarGraphicTest {
  ...
  public void testGetNearestNiceValue() {
    assertEquals(10.0, ScalebarGraphic.getNearestNiceValue(10.0, DistanceUnit.M, false), TOLERANCE);
    assertEquals(10.0, ScalebarGraphic.getNearestNiceValue(13.0, DistanceUnit.M, false), TOLERANCE);
    assertEquals(
        50.0, ScalebarGraphic.getNearestNiceValue(67.66871, DistanceUnit.M, false), TOLERANCE);
    assertEquals(
        0.02, ScalebarGraphic.getNearestNiceValue(0.0315, DistanceUnit.M, false), TOLERANCE);
    assertEquals(
        1000000000.0,
        ScalebarGraphic.getNearestNiceValue(1240005466, DistanceUnit.M, false),
        TOLERANCE);
    assertEquals(
        50.0, ScalebarGraphic.getNearestNiceValue(98.66871, DistanceUnit.M, false), TOLERANCE);
  }

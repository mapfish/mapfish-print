...
public class MapTransformerTest {
    ...
    public void testGetRotation() {
        MapTransformer transformer = new MapTransformer(null, null, 90, Constants.PDF_DPI);
    ...
    public void testGetRotatedBounds_BBoxMapBounds() {
        ...
        // rotate 90 degree
        MapTransformer transformer = new MapTransformer(bounds, null, 90, Constants.PDF_DPI);
        ...
        // rotate 180 degree
        transformer = new MapTransformer(bounds, null, 180, Constants.PDF_DPI);
        rotatedBounds = new BBoxMapBounds(DefaultGeographicCRS.WGS84, 5, 45, 25, 55);
        assertEquals(rotatedBounds, transformer.getRotatedBounds());

        // rotate 45 degree
        transformer = new MapTransformer(bounds, null, 45, Constants.PDF_DPI);
    ...
    public void testGetRotatedMapSize() {
        // no rotation
        MapTransformer transformer = new MapTransformer(null, new Dimension(1, 1), 0, Constants.PDF_DPI);
        assertEquals(new Dimension(1, 1), transformer.getRotatedMapSize());

        // rotate 90 degree
        transformer = new MapTransformer(null, new Dimension(2, 1), 90, Constants.PDF_DPI);
        assertEquals(new Dimension(1, 2), transformer.getRotatedMapSize());

        // rotate 180 degree
        transformer = new MapTransformer(null, new Dimension(2, 1), 180, Constants.PDF_DPI);
        assertEquals(new Dimension(2, 1), transformer.getRotatedMapSize());

        // rotate 45 degree
        transformer = new MapTransformer(null, new Dimension(100, 100), 45, Constants.PDF_DPI);
    ...
    public void testGetTransform() {
        ...
        // no rotation
        MapTransformer transformer = new MapTransformer(bounds, mapSize, 0, Constants.PDF_DPI);
        assertNull(transformer.getTransform());
        
        // rotate 180 degree
        transformer = new MapTransformer(bounds, mapSize, 180, Constants.PDF_DPI);
        ...
        // rotate 90 degree
        transformer = new MapTransformer(bounds, mapSize, 90, Constants.PDF_DPI);

...
public class CreateMapProcessorAoiTest extends AbstractMapfishSpringTest {
    ...
    public void testExecute() throws Exception {
        ...
        createMap(template, "expectedSimpleImage-default-transparent.png", RENDER, null, false, null, 45);
        /* jpeg */
        ...
        createMap(template, "expectedSimpleImage-render-polygon.png", RENDER, "polygon", false, null, 45);
        createMap(
            template,

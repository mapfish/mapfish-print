...
/**
 * Tests map rotation with small tiles. Bounds when getting tiles have to take rotation into
 * account.
 */
public class CreateMapProcessorCenterWMSRotationSmallTilesTest extends AbstractMapfishSpringTest {
  ...
  public static PJsonObject loadJsonRequestData() throws IOException {
    return parseJSONObjectFromFile(
        CreateMapProcessorCenterWMSRotationSmallTilesTest.class, BASE_DIR + "/requestData.json");
  }
  ...
  public void testExecute() throws Exception {
    requestFactory.registerHandler(
        ...
        new TestHttpClientFactory.Handler() {
          ...
          public MockClientHttpRequest handleRequest(URI uri, HttpMethod httpMethod)
            ...
            try {
              byte[] bytes =
                  Files.readAllBytes(getTile(parameters.get("bbox").iterator().next()).toPath());
    ...
    new ImageSimilarity(getFile(BASE_DIR + "/expectedSimpleImage.png"))
        .assertSimilarity(layerGraphics, 625, 625, 0);
  }

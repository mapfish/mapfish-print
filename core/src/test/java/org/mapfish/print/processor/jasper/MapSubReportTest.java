...
public class MapSubReportTest {
  ...
  public void testCompile() throws Exception {
    ...
    List<URI> layerImages =
        Arrays.asList(layer0Tiff.toURI(), layer1SVG.toURI(), layer2Tiff.toURI(), layer3SVG.toURI());
    ...
    assertEquals(
        '"' + layer0Tiff.getPath().replace('\\', '/') + '"', image0.getExpression().getText());

...
public class DataSourceAttributeTest extends AbstractMapfishSpringTest {
  ...
  public void testParseRequest() throws Exception {
    ...
    TableAttribute.TableAttributeValue table1 =
        (TableAttribute.TableAttributeValue) val1.get("table");
    TableAttribute.TableAttributeValue table2 =
        (TableAttribute.TableAttributeValue) val2.get("table");

...
public class BBoxMapBoundsTest {
    ...
    public void testAdjustToScale() {
        ...
        final CenterScaleMapBounds mapBounds = new CenterScaleMapBounds(
            CH1903,
            50000,
            50000,
            scaleDenominator
        ...
        BBoxMapBounds linear = new BBoxMapBounds(
            CH1903,
        ...
        final MapBounds newMapBounds = linear.adjustBoundsToNearestScale(
            zoomLevels,
            0.05,
        ...
        CenterScaleMapBounds expectedMapBounds = new CenterScaleMapBounds(
            CH1903,

...
public class ServletConfigFileLoaderTest extends AbstractConfigLoaderTest {
    ...
    public void testAccessibleChildResource() throws Exception {
        ...
        assertTrue(
            this.loader.isAccessible(
                    configFileUri,
                    "servlet:///org/mapfish/print/servlet/fileloader/" + resourceFileName
                )
        );
        ...
        assertTrue(
            this.loader.isAccessible(
                    configFileUri,
                    getFile(FileConfigFileLoader.class, resourceFileName).getAbsolutePath()
                )
        );
        assertTrue(
            this.loader.isAccessible(
        ...
        File file = getFile(FileConfigFileLoader.class, "/test-http-request-factory-application-context.xml");

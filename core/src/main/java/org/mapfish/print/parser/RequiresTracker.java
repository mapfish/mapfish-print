...
/**
 * Keeps track of the attributes that require other dependencies and verifies they are all satisfied
 * at the end of the json parsing.
 */
class RequiresTracker {
  ...
  /**
   * Check if field has the {@link org.mapfish.print.parser.Requires} annotation and registers it
   * and its requirement.
   *
  ...
  /**
   * Check if a field is part of a {@link org.mapfish.print.parser.Requires} relationship and mark
   * the requirement as satisfied for the given field.
   *

...
/**
 * Indicates that the annotated field or can satisfy the {@link org.mapfish.print.parser.OneOf}
 * requirements or can co-exist with that requirement.
 *
 * <p>If this annotation is present then {@link org.mapfish.print.parser.HasDefaultValue} is not
 * required.
 *

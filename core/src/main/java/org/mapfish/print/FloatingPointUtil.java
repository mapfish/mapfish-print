...
public final class FloatingPointUtil {
  ...
  /**
   * Check the equality of two floats taking into consideration the precision issue of floating
  ...
  /**
   * Check the equality of two doubles taking into consideration the precision issue of floating
   * point arithmetic in Java.
   *
   * @param d1 Double 1.
   * @param d2 Double 2.

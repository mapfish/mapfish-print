...
/**
 * The attributes for {@link org.mapfish.print.processor.map.CreateNorthArrowProcessor} (see <a
 * href="processors.html#!createNorthArrow">!createNorthArrow</a> processor).
 * [[examples=verboseExample,print_osm_new_york_nosubreports]]
 */
public class NorthArrowAttribute
    extends ReflectiveAttribute<NorthArrowAttribute.NorthArrowAttributeValues> {
   ...
   *
   * <p>The graphic is a square so that the arrow can be rotated properly.
   *
  ...
  public class NorthArrowAttributeValues {
     ...
     *
     * <p>While the resulting graphic used in the JasperReport template is a square, this graphic
     * can have an arbitrary aspect ratio. The graphic will be scaled to the output size and rotated
     * around its center.
     *
     * <p>If no graphic is given, a default north-arrow is used.
     */
    @HasDefaultValue public String graphic = null;

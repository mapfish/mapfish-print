...
/**
 * The attributes for the {@link org.mapfish.print.processor.map.AddStaticLayersProcessor} (see <a
 * href="processors.html#!addBackgroundLayers">!addBackgroundLayers</a> and <a
 * href="processors.html#!addOverlayLayers">!addOverlayLayers</a> processor) which adds the layers
...
public final class StaticLayersAttribute
  ...
  public static final class StaticLayersAttributeValue {
    /**
     * An array of layers (the same as for {@link
     * org.mapfish.print.attribute.map.MapAttribute.MapAttributeValues#layers}).
     *
     * <p>These layers will be added to the map.
     */

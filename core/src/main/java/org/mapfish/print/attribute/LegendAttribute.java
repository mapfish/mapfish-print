...
/**
 * Objects needed by the {@link org.mapfish.print.processor.jasper.LegendProcessor} (see <a
 * href="processors.html#!prepareLegend">!prepareLegend</a> processor).
 * [[examples=verboseExample,legend_cropped]]
 */
public final class LegendAttribute
    extends ReflectiveAttribute<LegendAttribute.LegendAttributeValue> {
  ...
  public static final class LegendAttributeValue {
    ...
    @HasDefaultValue public Double dpi;

    /** Urls for downloading icons for each legend row. */
    @HasDefaultValue public URL[] icons;

    /** Other embedded classes. */
    @HasDefaultValue public LegendAttributeValue[] classes;
  }
}

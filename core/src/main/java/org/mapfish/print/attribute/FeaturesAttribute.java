...
public final class FeaturesAttribute
    extends ReflectiveAttribute<FeaturesAttribute.FeaturesAttributeValues> {
  ...
  public static final class FeaturesAttributeValues {
    ...
    public synchronized SimpleFeatureCollection getFeatures(
        final MfClientHttpRequestFactory httpRequestFactory) throws IOException {
      if (this.featuresCollection == null) {
        final boolean forceLongitudeFirst =
            this.longitudeFirst == null ? false : this.longitudeFirst;

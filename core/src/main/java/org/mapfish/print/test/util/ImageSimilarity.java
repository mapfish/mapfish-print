...
public final class ImageSimilarity {
            ...
            this.expectedPath =
                new File(
                    expectedFile
                        .toString()
                        .replaceAll("/out/", "/src/")
                        .replaceAll("/build/classes/test/", "/src/test/resources/")
                );
        } else {
     ...
     */
    public void assertSimilarity(final byte[] graphicData, final double maxDistance) throws IOException {
     ...
     * @param maxDistance the maximum distance between the two images.
     */
    public void assertSimilarity(final JasperPrint jasperPrint, final Integer page, final double maxDistance)
    ...
    public void assertSimilarity(final BufferedImage actualImage, final double maxDistance)
        ...
        if (!this.expectedPath.exists()) {
            ...
            throw new AssertionError(
                "The expected file was missing and has been generated: " + expectedPath.getAbsolutePath()
            );
        }

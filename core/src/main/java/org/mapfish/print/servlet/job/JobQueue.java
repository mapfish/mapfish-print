...
public interface JobQueue {
   ...
   *
   * @return the number of milliseconds between the last access of a record and the time when a
   *     record can be purged from the registry. -1 if there it is unlimited.
   */
   ...
   * @throws NoSuchReferenceException
   */
  void cancel(String referenceId, String message, boolean forceFinal)
      throws NoSuchReferenceException;

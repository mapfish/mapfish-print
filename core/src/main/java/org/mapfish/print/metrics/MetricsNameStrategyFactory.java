...
public final class MetricsNameStrategyFactory {
  ...
  /**
   * Strategy for naming the http requests made for the metrics tracking. Host and method will be
   * tracked.
   */
  ...
  /**
   * Strategy for naming the http requests made for the metrics tracking. Only the http method is
   * tracked
   */
  ...
  /**
   * Strategy for naming the http requests made for the metrics tracking. Host, method and path will
   * be tracked.
   */

...
/**
 * The parameters for configuration an XYZ layer.
 */
public final class XyzLayerParam extends AbstractTiledLayerParams {
    ...
    public String createCommonUrl(
            final Function<Multimap<String, String>, Multimap<String, String>> function) throws URISyntaxException {
        return getBaseUrl();
    }

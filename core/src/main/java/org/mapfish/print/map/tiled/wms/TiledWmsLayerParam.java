 ...
 *
 * <p>What is meant by a "tiled wms layer" is a layer based on a WMS layer but instead of a single
 * large image for the layer multiple wms requests are made and the resulting images are combined as
 * tiles.
 */
public final class TiledWmsLayerParam extends WmsLayerParam {
  ...
  @HasDefaultValue public int[] tileBufferSize = new int[] {0, 0};

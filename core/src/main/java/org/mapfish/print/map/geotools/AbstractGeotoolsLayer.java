...
public abstract class AbstractGeotoolsLayer implements MapLayer {
   ...
   */
  protected AbstractGeotoolsLayer(
      final ExecutorService executorService, final AbstractLayerParams params) {
  ...
  public final void render(
    ...
    if (!FloatingPointUtil.equals(transformer.getRotation(), 0.0)
        && !this.supportsNativeRotation()) {

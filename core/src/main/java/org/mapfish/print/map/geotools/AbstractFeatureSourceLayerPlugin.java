...
/**
 * Abstract class for FeatureSource based {@link org.mapfish.print.map.MapLayerFactoryPlugin}
 * objects.
 *
...
public abstract class AbstractFeatureSourceLayerPlugin<P> implements MapLayerFactoryPlugin<P> {
  ...
  protected final StyleSupplier<FeatureSource<?, ?>> createStyleFunction(
    ...
    return (requestFactory, featureSource) -> {
      ...
      System.out.printf("HERE-PRINT: %s %s %s\n", styleString, styleRef, geomType);

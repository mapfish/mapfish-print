...
public abstract class AbstractWMXLayerParams extends AbstractTiledLayerParams {
   ...
   * server from being merged into a single request with both layers. See {@link #mergeableParams}
   * for a more detailed example of the difference between {@link #mergeableParams} and {@link
   * #customParams}.
   *
   ...
   * then the layers cannot be merged. In this case the DPI should <em>NOT</em> be one of the {@link
   * #mergeableParams} it should be one of the {@link #customParams}.
   */
  @HasDefaultValue public PJsonObject mergeableParams;

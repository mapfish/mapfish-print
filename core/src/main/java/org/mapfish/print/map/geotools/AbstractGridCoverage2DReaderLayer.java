...
public class AbstractGridCoverage2DReaderLayer extends AbstractGeotoolsLayer {
    ...
    private final Function<MapfishClientHttpRequestFactory, AbstractGridCoverage2DReader> coverage2DReaderSupplier;
     ...
     */
    public AbstractGridCoverage2DReaderLayer(final Function<MapfishClientHttpRequestFactory, AbstractGridCoverage2DReader> coverage2DReader,
    ...
    @Override
    public final synchronized List<? extends Layer> getLayers(final MapfishClientHttpRequestFactory httpRequestFactory,

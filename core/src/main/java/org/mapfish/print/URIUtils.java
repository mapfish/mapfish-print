...
public final class URIUtils {
     ...
     */
    public static String toString(final MapfishClientHttpRequestFactory requestFactory, final URI uri) throws IOException {
     ...
     * @return the data in string form.
     */
    public static String toString(final MapfishClientHttpRequestFactory requestFactory, final URL url) throws IOException {
        try {

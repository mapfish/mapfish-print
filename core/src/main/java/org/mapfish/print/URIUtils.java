...
public final class URIUtils {
  ...
  /**
   * Add a parameter to the query params (the params map) if there is not existing value for that
   * key.
   *
   * @param params the query parameters
   * @param key the key/param name
  ...
  /**
   * Construct a new uri by replacing query parameters in initialUri with the query parameters
   * provided.
   *
   * @param initialUri the initial/template URI
   * @param queryParams the new query parameters.
   */
  public static URI setQueryParams(

 ...
 *
 * <p>All implementations must be serializable.
 */
public interface AccessAssertion extends ConfigurationObject {
   ...
   *
   * <p>Will throw {@link
   * org.springframework.security.authentication.AuthenticationCredentialsNotFoundException} if the
   * user has not logged in or supplied credentials.
   *
   * <p>Will throw {@link org.springframework.security.access.AccessDeniedException} if the user is
   * logged in but may not access the resource.
   *

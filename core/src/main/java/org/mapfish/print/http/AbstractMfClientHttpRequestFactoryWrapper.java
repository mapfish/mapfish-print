...
public abstract class AbstractMfClientHttpRequestFactoryWrapper
   ...
   * MfClientHttpRequestFactory)} (if the matchers are OK) with the wrapped request factory provided
   * to the {@linkplain #AbstractMfClientHttpRequestFactoryWrapper(MfClientHttpRequestFactory,
   * UriMatchers, boolean) constructor}.
   *
  ...
  protected abstract ClientHttpRequest createRequest(
      URI uri, HttpMethod httpMethod, MfClientHttpRequestFactory requestFactory) throws IOException;

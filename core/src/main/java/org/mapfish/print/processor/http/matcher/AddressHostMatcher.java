 ...
 * </code></pre>
 *
 * <p>Example 2: accept any uri whose host ip starts with 192.1
 *
 * <pre><code>
 *     - !ipMatch
 *       ip: 192.1.0.0
 ...
 * </code></pre>
 *
 * <p>Example 3: accept any uri whose host ip starts with 192.1 and restricts to port 80
 *
 * <pre><code>
 *     - !ipMatch
 *       ip: 192.1.0.0
 ...
 * </code></pre>
 *
 * <p>Example 4: accept any uri whose host ip starts with 192.1 and and allows any port (-1 is any
 * port)
 *
 * <pre><code>
 *     - !ipMatch
 ...
 * </code></pre>
 *
 * <p>Example 5: accept any uri whose host ip starts with 192.1 and restricts to paths that start
 * with /print/
 *
 * <pre><code>
 *     - !ipMatch
  ...
  public final void validate(
    ...
    if (this.ip == null) {
      validationErrors.add(
          new ConfigurationException("No IP address defined " + getClass().getName()));
    }
  }

...
public final class MatchInfo {
  ...
  public static MatchInfo fromAuthScope(final AuthScope authscope) {
    ...
    String newScheme = Strings.CS.equals(authscope.getSchemeName(), ANY_SCHEME) ? ANY_SCHEME
      : authscope.getSchemeName();
    String newHost = Strings.CS.equals(authscope.getHost(), ANY_HOST) ? ANY_HOST
      : authscope.getHost();
    int newPort = authscope.getPort() == ANY_PORT ? ANY_PORT : authscope.getPort();
    String newRealm = Strings.CS.equals(authscope.getRealm(), ANY_REALM) ? ANY_REALM
      : authscope.getRealm();

 ...
 * </code></pre>
 *
 * <p>Example 2: Accept any localhost url (port == -1 accepts any port)
 *
 * <pre><code>
 *     - localMatch
 *       port: -1
 * </code></pre>
 *
 * <p>Example 3: Accept any localhost url on port 80 only
 *
 * <pre><code>
 *     - localMatch
 *       port: 80
 * </code></pre>
 *
 * <p>Example 4: Accept localhost urls with paths that start with /print/.
 *
 * <p>If the regular expression given does not start with / then it will be added because all paths
 * start with /.
 *
 * <pre><code>
 *     - localMatch

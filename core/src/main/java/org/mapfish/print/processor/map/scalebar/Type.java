...
public enum Type {
  ...
  /**
   * A bar with alternating black and white zones marking the sub-intervals. Intervals have small
   * additional ticks.
   */
  BAR_SUB("bar_sub") {
    @Override
   ...
   */
  public abstract ScalebarDrawer createDrawer(
      Graphics2D graphics2d, ScaleBarRenderSettings settings);

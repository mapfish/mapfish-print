...
public final class FontTools {
   ...
   * @param inputLine
   */
  private static void augmentFontConfigDescription(
      final FontConfigDescription description, final String inputLine) {
    ...
    if (split[0].equals("family")) {
      ...
      final int weight = Integer.parseInt(split[1].substring(0, split[1].length() - 6));

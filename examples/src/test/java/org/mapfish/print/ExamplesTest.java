...
// @ContextConfiguration(locations = {ExamplesTest.DEFAULT_SPRING_XML,
...
public class ExamplesTest {
  ...
  //
  //  /**
  //   * If this system property is set then it will be interpreted as a regular expression and will
  // be
  ...
  //      GFModelParser parser = GFModelParser.createModelWithFlavour(http.getInputStream(),
  // flavour);
